...
ps_new <- integrate(predict_supply, lower = 0, upper = q_new)
welfare_p_new <- 3 * q_new - ps_new$value # e.
...
solution_2 <- uniroot(function(x) aggregate_demand(x) - q_bar_half, c(0.01, 10))

tax <- solution_2$root - 3

aggregate_demand(10.30)
```
